...
CREATE TABLE `pensiones` (
  ...
  `dias` int NOT NULL,
  `fecha_autorizacion` varchar(255) NOT NULL,
  `fecha_reporte` varchar(255) NOT NULL,
  `orden_salida` bit(1) DEFAULT NULL,
  `patio` bit(1) DEFAULT NULL,
  `tanque1` bit(1) DEFAULT NULL,
  `tanque2` bit(1) DEFAULT NULL,
  `unidad_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKn20atalbejiambn2ercq39dle` (`unidad_id`),
  CONSTRAINT `FKn20atalbejiambn2ercq39dle` FOREIGN KEY (`unidad_id`) REFERENCES `unidades` (`id`)
